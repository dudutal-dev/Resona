  ...
  return (
    <Screen title="אודות" subtitle={`Resona · גרסה ${APP_VERSION}`} onBack>
      ...
      <Section title="נגינה ברקע ובמכשירים אחרים">
        <p>
          <strong>ניתוב למכשיר חיצוני:</strong> בוחרים את הרמקול, הטלוויזיה, הרכב או האוזניות
          ממרכז הבקרה של הטלפון (או מבורר פלט השמע במחשב). הבחירה מנתבת את כל מה שמתנגן במכשיר,
          כולל Resona.
        </p>
        <p>
          אין באפליקציה כפתור AirPlay משלה, וזו החלטה ולא חוסר: AirPlay מקבל רק קובץ מדיה, ולמוזיקה
          שנוצרת בזמן אמת אין קובץ למסור לו. ניסיון לעקוף את זה דרך הזרמה פנימית העלה את בורר
          המכשירים אבל לא השמיע כלום — ולכן הוסר לטובת הניתוב של מערכת ההפעלה, שעובד.
        </p>
        <p>
