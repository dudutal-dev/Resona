...
const HE = {
  ...
  'sound.lost': 'הקול נקטע',
  'sound.lostBody': 'משהו לקח את יציאת הקול — שיחה, או אפליקציה אחרת. הנגן ממשיך, והקול לא יוצא. לחיצה אחת מחזירה אותו.',
  'sound.restore': 'החזר את הקול',
  'sound.restored': 'הקול חזר',
  'share.action': 'שיתוף',
...
const EN: Record<StringKey, string> = {
  ...
  'sound.lost': 'The sound was cut off',
  'sound.lostBody': 'Something took the audio output — a call, or another app. The session is still running and nothing is coming out. One tap brings it back.',
  'sound.restore': 'Bring the sound back',
  'sound.restored': 'Sound is back',
  'share.action': 'Share',
