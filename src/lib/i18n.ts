...
const HE = {
  ...
  'style.organic': 'אורגני',
  'style.techno': 'טכנו',
  'style.trance': 'טראנס',
  'style.psytrance': 'פסיטראנס',
  'style.deephouse': 'דיפ האוס',
  'style.organic.note': 'מיתר נפרט ונשאר לדעוך — בלי גריד, בלי קיק, ובלי עליית עוצמה. אותן פרזות של האמביינט, אבל צפופות יותר, כי צליל פריטה נגמר תוך שנייה וחצי. הפריטה החזקה גם בהירה יותר, כמו בכלי אמיתי.',
...
const EN: Record<StringKey, string> = {
  ...
  'style.organic.note': 'A string is plucked and left to decay — no grid, no kick, and nothing that swells. The same phrases as ambient, packed closer together, because a plucked note is gone in a second and a half. A harder pluck is also a brighter one, as on a real instrument.',
