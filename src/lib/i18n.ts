...
const HE = {
  ...
  'figure.emerald': 'ברקת',
  'figure.amber': 'ענבר',
  'figure.cosmosTurn': 'קוסמוס — מסתובבת',
  'figure.seraphTurn': 'שרף — מסתובבת',
  ...
  'build.days.q': 'כמה ימים?',
  'build.days.hint': 'הסולם מתחלק על פני המספר הזה, אז שבוע ארוך יותר זו קפיצה קטנה יותר בכל פעם.',
  'build.minutes.q': 'כמה זמן בכל פעם?',
  'build.minutes.hint': 'אורך קבוע לכל יום. אפשר לשנות בטיימר בכל סשן.',
  ...
  'build.shape.hint': 'הכיוון שהסולם עושה לאורך הימים.',
  ...
  'build.shape.steady.note': 'שורש אחד לכל הימים. מה שמשתנה הוא רק איך הוא מנוגן',
  ...
  'journeys.footer': 'המסעות הם מבנה האזנה מוצע, לא פרוטוקול טיפולי. אפשר לדלג בין ימים בכל שלב, ואפשר לבנות מסע משלך בכמה שאלות — הכפתור למעלה.',
  ...
  'journey.byline': 'מסע מודרך · {n} ימים',
...
const EN: Record<StringKey, string> = {
  ...
  'figure.amber': 'Amber',
  'figure.cosmosTurn': 'Cosmos — turning',
  'figure.seraphTurn': 'Seraph — turning',
  'figure.scene': '3D',
  ...
  'build.days.q': 'How many days?',
  'build.days.hint': 'The scale is divided across this number, so a longer week is a smaller step each time.',
  'build.minutes.q': 'How long each time?',
  'build.minutes.hint': 'The same length every day. The timer can still be changed in any session.',
  ...
  'build.shape.hint': 'The direction the scale travels across the days.',
  ...
  'build.shape.steady.note': 'One root for every day. The only thing that changes is how it is played',
  ...
  'journeys.footer': 'A journey is a suggested listening structure, not a treatment protocol. You can skip between days at any point, and you can build one of your own from a few questions — the button at the top.',
  ...
  'journey.byline': 'Guided journey · {n} days',
