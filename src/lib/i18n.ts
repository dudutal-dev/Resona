...
const HE = {
  ...
  'common.minutes': 'דקות',
  'common.done': 'הושלם ✓',
  // A journey is walked at whatever pace suits: nothing in the app enforces one
  // a day, and calling them days was a promise it never kept.
  'common.stageN': 'שלב {n}',
  'common.stagesN': '{n} שלבים',
  'common.stageOf': 'שלב {n} מתוך {total}',
  ...
  'home.shelfSessions': 'סטים וסשנים',
  'home.shelfTrips': 'מסעות פסיכדליים',
  'home.shelfStarters': 'להתחיל מכאן',
  'home.shelfRoots': 'תדרי יסוד',
  ...
  'player.finishDay': 'סיים שלב',
  'player.saved': 'נשמר ✓',
  'player.byJourney': 'מסע מודרך · Resona',
  'player.withBand': 'עם {band} · {hz} Hz',
  'player.rootOnly': 'תדר יסוד בלבד',
  'player.credits': 'מידע',
  ...
  'player.finishNote': 'סימון השלב כהושלם. הדירוג נשמר מקומית ומופיע בסיכום המסע.',
  'player.defaultPresetName': 'פריסט',

  'mini.remaining': ' · נותרו {clock}',
  'mini.open': 'פתח את הנגן',
  ...
  'figure.emerald': 'ברקת',
  'figure.amber': 'ענבר',
  'figure.transfigure': 'התמרה',
  'figure.summit': 'מעל העננים',
  'figure.chakraTurn': 'נושאת הצ׳אקרות',
  'figure.medley': 'כל הדמויות',
  ...
  // ---------------------------------------------------------------- journeys
  'build.delete': 'מחק את המסע הזה',
  'build.deleteConfirm': 'למחוק את המסע הזה ואת ההתקדמות בו?',
  'build.entry': 'בנה מסע משלך',
  'build.entryNote': 'חמש שאלות, ומסע שנבנה לפי התשובות',
  'build.yours': 'המסע שלך',
  'build.keep': 'שמור מסע',
  'build.again': 'מהתחלה',
  'build.theWeek': 'השבוע עצמו',
  'build.goal.q': 'בשביל מה?',
  'build.goal.hint': 'זה קובע את גל המוח שירוץ מתחת, ואת הסולם שהמסע ילך בו.',
  'build.goal.sleep': 'להירדם',
  'build.goal.sleep.note': 'דלתא שיורד לילה אחרי לילה — המסע הוא הירידה עצמה',
  'build.goal.calm': 'להירגע',
  'build.goal.calm.note': 'אלפא, ערנות שקטה. לסוף היום או אחרי משהו',
  'build.goal.focus': 'להתרכז',
  'build.goal.focus.note': 'בטא, רקע לעבודה — נוכח בלי לדרוש קשב',
  'build.goal.energy': 'אנרגיה',
  'build.goal.energy.note': 'בטא עולה. לבוקר או לפני משהו',
  'build.goal.spiritual': 'פנימה',
  'build.goal.spiritual.note': 'תטא שמעמיק — מדיטציה, לא רקע',
  'build.goal.body': 'הגוף',
  'build.goal.body.note': 'אלפא יציב, לתרגול או למתיחות',
  'build.goal.club': 'רחבה',
  'build.goal.club.note': 'מנוע מועדון על גריד — קיק, בס, ברייקדאון',
  'build.days.q': 'כמה שלבים?',
  'build.days.hint': 'הסולם מתחלק על פני המספר הזה, אז מסע ארוך יותר זו קפיצה קטנה יותר בכל שלב.',
  'build.minutes.q': 'כמה זמן בכל פעם?',
  'build.minutes.hint': 'אורך קבוע לכל שלב. אפשר לשנות בטיימר בכל סשן.',
  'build.sound.q': 'איך זה צריך להישמע?',
  'build.sound.hint': 'זה משנה את הצפיפות, הקצב והעומק — לא את התדר.',
  'build.sound.still': 'שקט',
  'build.sound.still.note': 'תו אחד מחזיק ונפתח, והבא נכנס רק אחרי שהראשון כמעט נגמר',
  'build.sound.flowing': 'זורם',
  'build.sound.flowing.note': 'זרימה קבועה של תווים — נוכח מספיק להישען עליו',
  'build.sound.beat': 'עם קצב',
  'build.sound.beat.note': 'על גריד. אם לא בחרת רחבה, זה יישאר זורם',
  'build.shape.q': 'לאן זה הולך?',
  'build.shape.hint': 'הכיוון שהסולם עושה לאורך השלבים.',
  'build.shape.ascending': 'עולה',
  'build.shape.ascending.note': 'מהתדרים הנמוכים לגבוהים — נפתח',
  'build.shape.descending': 'יורד',
  'build.shape.descending.note': 'מהגבוהים לנמוכים — שוקע',
  'build.shape.steady': 'יציב',
  'build.shape.steady.note': 'שורש אחד לכל השלבים. מה שמשתנה הוא רק איך הוא מנוגן',
  ...
  'journeys.footer': 'המסעות הם מבנה האזנה מוצע, לא פרוטוקול טיפולי. השלבים אינם קצובים ליום — אפשר לדלג ביניהם ולהתקדם בקצב שלך, ואפשר לבנות מסע משלך בכמה שאלות.',
  ...
  'journey.continue': 'המשך — שלב {n}',
  'journey.byline': 'מסע מודרך · {n} שלבים',
  'journey.start': 'התחל מסע',
  'journey.resetConfirm': 'לאפס את ההתקדמות במסע הזה?',
  'journey.reset': 'איפוס התקדמות',
  'journey.today': 'היום שלך',

  'day.notFound': 'שלב לא נמצא',
  'day.notFoundBody': 'אין שלב כזה במסע הזה.',
  'day.supporting': 'מתחת לתדר רץ גל מוחי תומך — ',
  'day.supportingTail': ', בעוצמה נמוכה כדי שתדר השלב יישאר במרכז.',
  'day.start': 'התחל את השלב',
  'day.again': 'האזן שוב לשלב הזה',
  ...
  'day.moodNew': 'דירוג מסמן את השלב כהושלם ומעביר לשלב הבא.',
  ...
  'sound.lost': 'לא שומע כלום?',
  'sound.lostBody': 'משהו לקח את יציאת הקול בזמן שהיית בחוץ — שיחה או אפליקציה אחרת. אם הקול חזר, אפשר לסגור את ההודעה. אם לא — כל לחיצה מנסה דרך חזקה יותר.',
  'sound.restore': 'החזר את הקול',
  'sound.retry': 'עדיין אין קול — נסה חזק יותר',
  'sound.last': 'ניסיון אחרון: יציאה ישירה לרמקול',
  'sound.exhausted': 'ניסינו הכול. אם עדיין אין קול, שלח לי את יומן האבחון — הוא מכיל בדיוק מה שקרה.',
  'sound.tried': 'ניסיתי. תקשיב רגע.',
  'share.action': 'שיתוף',
  'share.journeyLine': 'שלחתי לך מסע ב-Resona — «{title}», {n} שלבים של מוזיקה שנבנית סביב תדר אחד:',
  'share.ask': 'האפליקציה עוד בבנייה, אז אם משהו נשמע מוזר, נתקע או פשוט לא ברור — ספר לי. דיווח אחד שווה יותר מעשר בדיקות שלי.',
  'share.freqLine': 'שלחתי לך תדר ב-Resona — {name}, {hz} Hz, עם מוזיקה שמולחנת סביבו:',
  'share.copied': 'הקישור הועתק',
  'share.failed': 'השיתוף לא הצליח',
  'shared.title': 'זה נשלח אליך',
  'shared.body': 'Resona פועלת ישירות בדפדפן — אפשר להאזין עכשיו, בלי הרשמה ובלי התקנה. כדי שתישאר כמו אפליקציה: <b>שיתוף ← הוספה למסך הבית</b>.',
  'shared.what': 'מה זה Resona',
  'shared.report': 'ואם משהו נתקע או נשמע לא נכון: <b>הגדרות ← יומן אבחון ← שיתוף</b>, ושלח חזרה למי ששלח לך. שם רשום מה בדיוק קרה.',
  'settings.update': 'עדכוני אפליקציה',
  'settings.updateHint': 'האפליקציה מותקנת אצלך על המסך ולכן היא כמעט אף פעם לא נטענת מחדש — היא רק מתעוררת. הכפתור הזה שואל את השרת אם יש גרסה חדשה, ואם יש, טוען אותה עכשיו. אם משהו מתנגן, הוא ייעצר.',
  'settings.updateCheck': 'בדוק עדכונים',
  'settings.updateChecking': 'בודק…',
  'settings.updateFound': 'נמצאה גרסה חדשה — טוען מחדש…',
  'settings.updateCurrent': 'זו הגרסה העדכנית ביותר.',
  'settings.updateUnmanaged': 'אין כאן שירות רקע (דפדפן בפיתוח או קובץ בודד) — טעינה מחדש רגילה תביא את הגרסה החדשה.',
  'settings.updateFailed': 'הבדיקה נכשלה — כנראה אין חיבור לרשת.',
  'settings.updateReload': 'טען מחדש',
  'settings.updateBuild': 'הגרסה שרצה עכשיו',
  'settings.diag': 'יומן אבחון',
  'settings.diagHint': 'האפליקציה רושמת לעצמה מה קרה לסאונד — הפסקות, התאוששות, נתק בשידור, שגיאות. הכול נשאר על המכשיר הזה ולא נשלח לשום מקום; אם משהו נתקע, אפשר לשלוח את היומן ולראות מה באמת קרה.',
  'settings.diagCount': '{n} רשומות',
  'settings.diagEmpty': 'אין עדיין רשומות.',
  'settings.diagShare': 'שיתוף היומן',
  'settings.diagCopy': 'העתקה',
  'settings.diagCopied': 'הועתק',
  'settings.diagClear': 'ניקוי היומן',
  ...
  'style.plucked': 'פריטה',
  'style.organichouse': 'אורגני האוס',
  'style.trippy': 'טריפי',
  'style.techno': 'טכנו',
  'style.trance': 'טראנס',
  'style.psytrance': 'פסיטראנס',
  'style.deephouse': 'דיפ האוס',
  'style.plucked.note': 'מיתר נפרט ונשאר לדעוך — בלי גריד, בלי קיק, ובלי עליית עוצמה. אותן פרזות של האמביינט, אבל צפופות יותר, כי צליל פריטה נגמר תוך שנייה וחצי. הפריטה החזקה גם בהירה יותר, כמו בכלי אמיתי.',
  'style.organichouse.note': 'דיפ האוס שמנוגן בידיים: אותו שאפל, עמוק יותר, קיק רך שמרגישים ולא שומעים, וכלי הקשה מעץ במקום מחיאה אלקטרונית — קונגה, רים ושייקר שנופלים ליד המשבצת ולא עליה. הבס קצר ונפרט במקום ארוך ומתמשך.',
  'style.trippy.note': 'לא נועד לרחבה. 104 פעימות, קיק שמסמן זמן במקום להוביל, דיליי דאב ארוך שמחזיר כל תו וחצי מהמקום שממנו הוא בא, ופילטר שנע כל הזמן. מחזור של 32 תיבות כדי שתפסיק לספור.',
  ...
  'output.background': 'המשך לנגן ברקע',
  'output.backgroundNote': 'מעביר את המיקס דרך נגן המדיה של המערכת במקום ישר לרמקול — זה מה שנותן לסשן סיכוי לשרוד מעבר לאפליקציה אחרת. אם המסלול לא מעביר קול, האפליקציה חוזרת לבד לנתיב הישיר.',
  'output.backgroundLater': 'ישתנה בהפעלה הבאה — העברת המסלול באמצע סשן משתיקה אותו לרגע.',
...
const EN: Record<StringKey, string> = {
  ...
  'common.stagesN': '{n} stages',
  'common.stageOf': 'Stage {n} of {total}',
  ...
  'home.seeAll': 'See all',
  'home.shelfSessions': 'Sets and sessions',
  'home.shelfTrips': 'Psychedelic trips',
  'home.shelfStarters': 'Start here',
  'home.shelfRoots': 'Root frequencies',
  ...
  'player.finishDay': 'Finish stage',
  'player.saved': 'Saved ✓',
  'player.byJourney': 'Guided journey · Resona',
  'player.withBand': 'With {band} · {hz} Hz',
  'player.rootOnly': 'Root frequency only',
  ...
  'player.finishNote': 'Marks the stage complete. The rating is stored locally and appears in the journey summary.',
  'player.defaultPresetName': 'Preset',

  'mini.remaining': ' · {clock} left',
  'mini.open': 'Open the player',
  ...
  'figure.amber': 'Amber',
  'figure.transfigure': 'Transfigured',
  'figure.summit': 'Above the clouds',
  'figure.chakraTurn': 'The chakra bearer',
  'figure.medley': 'Every figure',
  'figure.scene': '3D',
  ...
  'build.delete': 'Delete this journey',
  'build.deleteConfirm': 'Delete this journey and its progress?',
  'build.entry': 'Build your own journey',
  'build.entryNote': 'Five questions, and a journey composed from the answers',
  'build.yours': 'Your journey',
  'build.keep': 'Keep it',
  'build.again': 'Start over',
  'build.theWeek': 'The week itself',
  'build.goal.q': 'What is it for?',
  'build.goal.hint': 'This decides the brainwave band underneath, and the scale the journey walks.',
  'build.goal.sleep': 'Falling asleep',
  'build.goal.sleep.note': 'Delta, descending night after night — the descent is the treatment',
  'build.goal.calm': 'Settling',
  'build.goal.calm.note': 'Alpha, calm alertness. For the end of a day, or after something',
  'build.goal.focus': 'Concentration',
  'build.goal.focus.note': 'Beta, as background for work — present without asking for attention',
  'build.goal.energy': 'Energy',
  'build.goal.energy.note': 'Beta, rising. For a morning, or before something',
  'build.goal.spiritual': 'Inward',
  'build.goal.spiritual.note': 'Theta, deepening — meditation rather than background',
  'build.goal.body': 'The body',
  'build.goal.body.note': 'Steady alpha, for practice or stretching',
  'build.goal.club': 'The floor',
  'build.goal.club.note': 'A club engine on a grid — kick, bass, breakdown',
  'build.days.q': 'How many stages?',
  'build.days.hint': 'The scale is divided across this number, so a longer journey is a smaller step at each stage.',
  'build.minutes.q': 'How long each time?',
  'build.minutes.hint': 'The same length at every stage. The timer can still be changed in any session.',
  'build.sound.q': 'How should it sound?',
  'build.sound.hint': 'This changes the density, the pace and the depth — not the frequency.',
  'build.sound.still': 'Still',
  'build.sound.still.note': 'A tone holds and opens, and the next arrives once the first has nearly gone',
  'build.sound.flowing': 'Flowing',
  'build.sound.flowing.note': 'A steady flow of notes — present enough to lean on',
  'build.sound.beat': 'With a beat',
  'build.sound.beat.note': 'On a grid. Unless you chose the floor, this stays flowing',
  'build.shape.q': 'Which way does it go?',
  'build.shape.hint': 'The direction the scale travels across the stages.',
  'build.shape.ascending': 'Climbing',
  'build.shape.ascending.note': 'Low frequencies up to high — opening',
  'build.shape.descending': 'Falling',
  'build.shape.descending.note': 'High down to low — settling',
  'build.shape.steady': 'Steady',
  'build.shape.steady.note': 'One root for every stage. The only thing that changes is how it is played',
  ...
  'journeys.footer': 'A journey is a suggested listening structure, not a treatment protocol. The stages are not tied to a day each — move between them at your own pace, and you can build one of your own from a few questions.',
  ...
  'journey.continue': 'Continue — stage {n}',
  'journey.byline': 'Guided journey · {n} stages',
  ...
  'day.notFound': 'Stage not found',
  'day.notFoundBody': 'This journey has no such stage.',
  'day.supporting': 'A supporting brainwave band runs underneath — ',
  'day.supportingTail': ', at a low level so the stage’s own frequency stays in front.',
  'day.start': 'Start the stage',
  'day.again': 'Listen to this stage again',
  ...
  'day.moodNew': 'Rating marks the stage complete and moves you to the next one.',
  ...
  'sound.lost': 'Hearing nothing?',
  'sound.lostBody': 'Something took the audio output while you were away — a call, or another app. If the sound came back, dismiss this. If not, each tap tries something stronger.',
  'sound.restore': 'Bring the sound back',
  'sound.retry': 'Still silent — try harder',
  'sound.last': 'Last resort: straight to the speaker',
  'sound.exhausted': 'That was everything. If it is still silent, send me the diagnostics log — it has exactly what happened.',
  'sound.tried': 'Tried. Have a listen.',
  'share.action': 'Share',
  'share.journeyLine': 'Sending you a journey in Resona — “{title}”, {n} stages of music built around a single frequency:',
  'share.ask': 'It is still being built, so if anything sounds wrong, gets stuck, or simply is not clear — tell me. One report is worth ten of my own tests.',
  'share.freqLine': 'Sending you a frequency in Resona — {name}, {hz} Hz, with music composed around it:',
  'share.copied': 'Link copied',
  'share.failed': 'Sharing did not go through',
  'shared.title': 'This was sent to you',
  'shared.body': 'Resona runs in the browser — listen now, no account and no install. To keep it like an app: <b>Share → Add to Home Screen</b>.',
  'shared.what': 'What Resona is',
  'shared.report': 'And if anything gets stuck or sounds wrong: <b>Settings → Diagnostics log → Share</b>, and send it back to whoever sent you this. It records what actually happened.',
  'settings.update': 'App updates',
  'settings.updateHint': 'Installed on your home screen, the app is almost never loaded — only resumed, so a new build can sit unnoticed. This asks the server whether there is one, and loads it now if there is. Anything playing will stop.',
  'settings.updateCheck': 'Check for updates',
  'settings.updateChecking': 'Checking…',
  'settings.updateFound': 'New version found — reloading…',
  'settings.updateCurrent': 'This is the newest build.',
  'settings.updateUnmanaged': 'No service worker here (dev server or the single-file build) — a plain reload already fetches the newest code.',
  'settings.updateFailed': 'The check failed — most likely no network.',
  'settings.updateReload': 'Reload',
  'settings.updateBuild': 'Running build',
  'settings.diag': 'Diagnostics log',
  'settings.diagHint': 'The app writes down what happened to the sound — interruptions, recoveries, a dropped cast, errors. It stays on this device and is never sent anywhere; if something gets stuck, send the log and the cause is usually in it.',
  'settings.diagCount': '{n} entries',
  'settings.diagEmpty': 'Nothing recorded yet.',
  'settings.diagShare': 'Share the log',
  'settings.diagCopy': 'Copy',
  'settings.diagCopied': 'Copied',
  'settings.diagClear': 'Clear the log',
  ...
  'style.plucked': 'Plucked',
  'style.organichouse': 'Organic house',
  'style.trippy': 'Trippy',
  'style.techno': 'Techno',
  'style.trance': 'Trance',
  'style.psytrance': 'Psytrance',
  'style.deephouse': 'Deep house',
  'style.plucked.note': 'A string is plucked and left to decay — no grid, no kick, and nothing that swells. The same phrases as ambient, packed closer together, because a plucked note is gone in a second and a half. A harder pluck is also a brighter one, as on a real instrument.',
  'style.organichouse.note': 'Deep house played by hands: the same shuffle, deeper, a soft kick you feel rather than hear, and wooden percussion instead of an electronic clap — conga, rim and shaker landing beside the grid rather than on it. The bass is short and plucked instead of long and sustained.',
  'style.trippy.note': 'Not for a dancefloor. 104 BPM, a kick that marks time rather than leading, a long dub delay that sends every other note back where it came from, and a filter that never settles. A 32-bar cycle, so you stop counting.',
  ...
  'output.background': 'Keep playing in the background',
  'output.backgroundNote': 'Routes the mix through the system media player instead of straight to the speaker — the one thing that gives a session a chance of surviving a switch to another app. If the route carries no audio the app falls back to the direct path on its own.',
  'output.backgroundLater': 'Takes effect on the next play — moving the route mid-session silences it for a moment.',
